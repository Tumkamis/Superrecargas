...
class paquete extends CI_Controller{
    ...
    public function index() {
        ...
        $data['paquetes'] = $this->paquete_model->consultar_paquetes();
        //Para almacenar los modulos de cada rol
        ///$data['modulos'] = array();
        $data['titulo'] = "Súper Recarga | Paquetes";
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/paquete_view', $data, TRUE);
