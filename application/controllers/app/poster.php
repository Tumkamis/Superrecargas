...
class poster extends CI_Controller {
    ...
    public function index() {
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/poster_admin_view', $data, TRUE);
    ...
    public function mi_poster() {
        ...
        //Para almacenar los modulos de cada rol
        ///$data['modulos'] = array();
        $data['titulo'] = "Simposio | Mi poster";
        $data['tipo'] = $this->session->userdata('tipo');
        $data['expositor'] = $this->session->userdata('expositor');
        $data['nanoarte'] = $this->session->userdata('nanoarte');
        $data['poster'] = $this->usuario_model->miposter($this->session->userdata('idusu'));
         ...
         * Referencia al fragmento del contenido de esta sección
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/poster_usuario_view', $data, TRUE);
