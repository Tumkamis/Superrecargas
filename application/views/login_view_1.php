                        ...
                        <div class="panel-body" style="background-color: #F2F2F2;">
                            ...
                            <form action="<?= base_url() ?>auth" method="post" id="loginForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="*Campo obligatorio" title="Por favor ingresa tu número celular" value="" name="username" id="username" class="form-control" maxlength="10">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" title="Por favor ingresa tu contraseña" placeholder="******" value="" name="password" id="password" class="form-control">
                                    <span class="help-block"></span>
                                    </div>
                                </div>
