<?php
/**
 * Vista para eliminacion de mapas curriculares
 *
 * Vista que muestra al usuario la interfaz grafica para eliminar mapas curriculares
 * 
 * @since      1.0
 * @version    1.0
 * @link       /notfound
 * @package    application.views
 * @subpackage area_de_trabajo.Mapas_curriculares
                ...
                <div class="hpanel hblue">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" id="form">
                            ...
                            <div class="form-group">
                                <label for="nombre" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">Periodo</label> 
                                <input type="text" id="nombre_asig" name="nombre_asig" placeholder="*Campo requerido" class="form-control" disabled>
                            </div>
                            <div>
