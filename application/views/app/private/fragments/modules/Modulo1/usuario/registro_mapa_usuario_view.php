<?php
/**
 * Vista de registros de mapa curricular (aspirante)
 *
 * Vista que muestra al usuario la interfaz gráfica para el llenado de datos que se requieren al momento de 
 * registrar un mapa curricular y las asignaturas que lleva, además ver que documentos han sido aceptados y observaciones..
 * @since      1.0
 * @version    1.0
 * @link       /notfound
                                ...
                                <div class="form-group col-lg-9" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="panel panel-info">
                                            <div class="panel-heading" role="tab" id="heading_mapa_curricular">
                                                <h4 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#obse_mapa_curricular" aria-expanded="true" aria-controls="obse_mapa_curricular">
                                                        Observaciones
                                                    </a>
                                                </h4>
                                            </div>
                                            <div id="obse_mapa_curricular" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_mapa_curricular">
                                    ...
                                    <div class="col-sm-8">
                                        <label><h3>Oficio de aceptación del mapa curricular</h3></label>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="checkbox">
                                            <label><input type="checkbox" class="i-checks" id="docu_oficio_aceptacion" name="docu_oficio_aceptacion" disabled="disabled" checked> Aceptado </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-8">
                                        Descripción.
                                    ...
                                    <div class="col-sm-4">
                                        <div class="panel panel-info">
                                            <div class="panel-heading" role="tab" id="heading_oficio_aceptacion">
                                                <h4 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#obse_oficio_aceptacion" aria-expanded="true" aria-controls="obse_oficio_aceptacion">
                                                        Observaciones
                                                    </a>
                                                </h4>
                                            </div>
                                            <div id="obse_oficio_aceptacion" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_oficio_aceptacion">
                                                <div class="panel-body">
                                                    Sin observaciones.
                                                </div>
                                            </div>
                                    ...
                                    <!--<div class="col-sm-4">
                                        <label>Observaciones</label>
                                        <textarea id="obse_oficio_aceptacion" name="obse_oficio_aceptacion" rows="3" cols="30" disabled="disabled">Sin observaciones</textarea>
                                    </div>-->
