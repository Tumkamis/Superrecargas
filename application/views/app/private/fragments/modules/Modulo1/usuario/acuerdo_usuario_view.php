        ...
        <div class="hpanel hblue">
            ...
            <div class="panel-body">
                ...
                <div class="col-sm-6">
                    <div class="table-responsive">
                        ...
                        <?php if(!is_null($documentos)):
                            ...
                            <iframe id="acuerdo" src="<?=  base_url()?>static/acuerdos/acuerdo_<?= $acuerdoActual?>/<?= $docAcuerdo->pdf ?>" width="500" height="700" style="border: none;" allowfullscreen></iframe>
                            <?php           endif;
                                        endforeach;
                                  endif;
                            ?>
                ...
                <div class="col-sm-6">
                                                ...
                                                <td>                            
                                                    <a>
                                                        <button class="btn btn-primary mostrarDocumento" x="<?=$contador?>" type="button" id="visualizar" name="mostrarDocumento">
                                                            ...
                                                            <input id="doc-<?=$contador?>" type="hidden" value="<?=  base_url()?>static/acuerdos/acuerdo_<?= $acuerdoActual?>/<?= $documento->pdf ?>">
                                                        </button>       
                                                    </a>
                                                </td>
                                                <td>  
                                                    <a href="<?= base_url() ?>usuario/historial_documento/mostrar_historial">
                    ...
                    <div id="documento" title="pdf" class="pruebadocs" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        <form>
