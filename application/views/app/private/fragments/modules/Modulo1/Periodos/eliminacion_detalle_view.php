<?php
/**
 * Vista para eliminar una asignatura del detalle de periodos
 *
 * Vista que muestra al usuario la interfaz grafica para eliminar  asignaturas del periodo
 * 
 * @since      1.0
 * @version    1.0
 * @link       /notfound
                ...
                <div class="hpanel hblue">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" id="form">
                            ...
                            <div class="form-group">
                                <label for="nombre" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">Nombre Asignatura</label> 
                                <input type="text" id="nombre_asig" name="nombre_asig" placeholder="*Campo requerido" class="form-control" disabled>
                            </div>
                            
                            <div>
                                <button class="btn btn-sm btn-primary m-t-n-xs" type="submit"><strong><i class="fa fa fa-close"> </i> Eliminar</strong></button>
                                <a href="<?php base_url()?>detalle"><button class="btn btn-sm btn-danger m-t-n-xs" type="button"><strong><i class="fa fa fa-ban"> </i> Cancelar</strong></button></a>
                            </div>
                        </form>
                        <!-- ./form -->
                    </div>
