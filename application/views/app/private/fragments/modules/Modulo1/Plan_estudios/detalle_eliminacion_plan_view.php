<?php
/**
 * Vista de la eliminacion  del detalle de plan de estudios
 *
 * Vista que muestra al usuario la interfaz grafica para la eliminacion del detalle  plan de estudios
 * 
 * @since      1.0
 * @version    1.0
 * @link       /notfound
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" id="form">
                            <div class="form-group">
                                <label for="nombre" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">Nombre Plan</label> 
                            ...
                            <div>
                                <button class="btn btn-sm btn-primary m-t-n-xs" type="submit"><strong><i class="fa fa-file-text"> </i> Eliminar</strong></button>
