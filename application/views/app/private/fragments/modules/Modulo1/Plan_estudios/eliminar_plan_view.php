<?php
/**
 * Vista de la eliminacion de plan de estudios
 *
 * Vista que muestra al usuario la interfaz grafica para eliminar plan de estudios
 * 
 * @since      1.0
 * @version    1.0
 * @link       /notfound
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" id="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="nombre_asig" name="nombre_asig" placeholder="*Campo requerido" class="form-control" disabled>
                            </div>                            
