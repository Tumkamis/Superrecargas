...
<link rel='stylesheet' href='<?= base_url() ?>static/vendor/fullcalendar/fullcalendar.css' />
...
<script type="text/javascript">var plugin_path = '<?=base_url()?>static/plugins/';</script>
...
?>
                {
                    ...
                    //title: 'Ocupado',
                    title: '<?= substr($row->descripcion, 0, 24) ?><?= (strlen($row->descripcion) > 24) ? "..." : NULL ?>',
                    ...
                    icon: 'fa-clock-o',
                    owner: <?= ($valoridrol->rol == 12 || $valoridrol->rol ==2) ? 'true' : 'false' ?>
                                    ...
                                    function initCalendar() {
                                        ...
                                        jQuery('#calendar').fullCalendar({
                                            ...
                                            select: function (start, end, allDay) {
                                                ...
                                                horaFin = (horaFin == '00:00') ? '17:00' : horaFin;
                                                ...
                                                $.post(base_url()+"app/eventos/instituciones", {
                                                }, function (data) {
...
//                                                        $("#e_fecha_finev").val(json.evento_data.fechafin);
                                                        $("#e_idanalista_hidden").val(json.evento_data.idsolicitud);
                                                        var actual = json.evento_data.idsolicitud;
                                                        console.log(actual);
                                                        $.post(base_url()+"app/eventos/instituciones_editar/"+actual, {
                                                        }, function (data) {
                                                            $("#e_idanalista").html(data);
                                                            });
...
//                                    alert('funciono');
                                        $.ajax({
                                            url: base_url() + "app/eventos/create_cita",
                                            type: "post",
                                            dataType: "json",
...
//                        _toastr("Evento agregado correctamenete","top-right","success",false);
                                                ...
                                                swal({
                                                            title: "Cita agendada correctamenete",
                                                            text: "",
                                                            type: "success"
                                                        },
                                                                function () {
                                                                    location.href = base_url()+"app/eventos";
                                                                });
                                            },
                                            error: function (a, b, c) {
                                                alert("No Agregado " + c);
