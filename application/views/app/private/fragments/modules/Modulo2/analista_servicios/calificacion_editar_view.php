            ...
            <div class="panel-body">
                ...
                <form role="form" id="form">
                    ...
                    <div class="text-right">
                        <a href="<?= base_url() ?>analista_servicios/calificacion_gestion" class="btn btn-primary" 
                            ><i class="fa fa-check"> </i> Actualizar
                        </a>

                        <a href="<?= base_url() ?>analista_servicios/calificacion_gestion" class="btn btn-danger" 
