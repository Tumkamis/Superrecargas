 ...
 * @uses       ./application/controllers/app/inscritos_usuario
 */
?>
            ...
            <div class="panel-body" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <!-- col-lg-12 START -->
                                <div class="col-lg-12" >
                                    <button class="btn btn-danger observacionInscripcion text-left" 
                                            type="button" id="observacioninscripcion" name="observacioninscripcion" >
