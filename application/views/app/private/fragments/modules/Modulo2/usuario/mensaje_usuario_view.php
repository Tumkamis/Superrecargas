 ...
 * @uses       ./application/controllers/app/mensaje_usuario
 */
?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col-lg-12 START -->
                                <div class="col-lg-12" >
                                    <button class="btn btn-primary next aceptarInscripcion text-left" type="button" id="aceptarInscripcion" name="aceptarInscripcion" >
