                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mu-page-breadcrumb-area">
                            <h2>Cine Científico</h2>
                            <ol class="breadcrumb">
                                <li><a href="#">Home</a></li>            
                                <li class="active">Cine Científico</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mu-error-area">
                            <p>NANO</p>
                            <center>
                                <img src="<?= base_url() ?>static/assets/img/nano.jpg">
                            </center>
                            <br>
                            <div align="justify">
                                <span>Una revolución nanotecnológica futurista plantea la posibilidad de introducir esta disciplina en el torrente sanguíneo de los humanos, llamándose “nano versión 2.0”; con esta tecnología se puede sincronizar con aplicaciones informáticas para aumentar el genoma humano. Con la ayuda de esta tecnología el crimen queda casi completamente erradicado, el uso de las armas de fuego se ha reducido considerablemente al igual que los encuentros violentos, sin embargo, la libertad y la autonomía de cada individuo se ve afectada, además se debe lidiar con un grupo de “hacktivistas” dispuestos a frustrar la evolución de la “nano versión 2.0”.
                                    Durante el cortometraje se plantean interrogantes en torno a la ética al implementar esta tecnología, si bien, son planteadas varias ventajas no deja de ser peligrosa si su control cae en las manos equivocadas, será acaso que la nanotecnología del futuro ¿podría en algún punto, ser más perjudicial que beneficioso para la humanidad?
                                </span>
                            </div>
